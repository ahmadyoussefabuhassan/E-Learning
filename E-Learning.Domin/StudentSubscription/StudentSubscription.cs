...
namespace E_Learning.Domain.StudentSubscription
{
    public sealed class StudentSubscription : Entity
    {
        ...
        private StudentSubscription(Guid id, Guid studentId, Guid targetId, StudentSubscriptionTargetType targetType, ReceiptImageUrl receiptImageUrl, SubscriptionStatus status, PriceAtPurchase priceAtPurchase, DateTime createdAt)
            : base(id)
        {
            StudentId = studentId;
            TargetId = targetId;
        ...
        public StudentSubscriptionTargetType TargetType { get; private set; }
        ...
        public static StudentSubscription Create(Guid studentId, Guid targetId, StudentSubscriptionTargetType targetType, ReceiptImageUrl receiptImageUrl, SubscriptionStatus status , PriceAtPurchase priceAtPurchase)
        {
