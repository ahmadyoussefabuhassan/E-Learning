...
{
    public sealed class AddTeacherCommandHandler : ICommandHandler<AddTeacherCommand, Guid>
    {
        ...
        public async Task<Result<Guid>> Handle(AddTeacherCommand request, CancellationToken cancellationToken)
        {
