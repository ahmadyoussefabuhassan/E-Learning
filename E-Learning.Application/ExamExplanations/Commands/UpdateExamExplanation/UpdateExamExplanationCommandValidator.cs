...
{
    internal sealed class UpdateExamExplanationCommandValidator : AbstractValidator<UpdateExamExplanationCommand>
    {
        public UpdateExamExplanationCommandValidator()
        {
